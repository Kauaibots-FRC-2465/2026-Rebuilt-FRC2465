...
public final class ShooterConstants {
    ...
    static final double COMMANDED_MOVING_SHOT_FLYWHEEL_PREDICTION_SECONDS =
            COMMANDED_SHOOTER_LOOKAHEAD_SECONDS;
    ...
    static final double COMMANDED_EMPIRICAL_MOVING_SHOT_RADIAL_DISTANCE_BIAS_SECONDS = 0;
